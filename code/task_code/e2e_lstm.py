...
RE_TRAIN_model=args.RE_model
RE_epoch=args.RE_epoch

MODEL_str =args.MODEL_str
GPU_='0'

# n_gpu, GPU_, MODEL_str, TAXONOMY, TRANS_opt, trans_lr, trans_n_addL, RE_TRAIN_model, RE_epoch= sys.argv[1:]

n_gpu = int(n_gpu)
GPU_device = '/gpu:'+GPU_
RE_epoch=int(RE_epoch)
...
def data_valid( pair_dataset, table_seq, table_smile):
    ...
    X_compound = table_smile.loc[temp_com].values

    X_in=[X_prot,  X_compound]
