...
def data_valid(pair_dataset, table_prot0, table_mol2ecfp):
    # get protein 
...
def train_generator(batch_size, pair_dataset, table_prot0, table_mol2ecfp):
...
with tf.device('/cpu:0'):
    model= MODEL_dic[args.MODEL_str](dropout_value=0.5, vec=0 )
