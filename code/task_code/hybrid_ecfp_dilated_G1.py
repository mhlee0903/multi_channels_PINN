...
def data_valid(pair_dataset, table_aa, table_prot0, table_smile, table_mol2ecfp):
    # get protein 
...
def train_generator(batch_size, pair_dataset, table_aa, table_prot0,table_smile, table_mol2ecfp):
